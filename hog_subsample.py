...
for xb in range(nxsteps):
        for yb in range(nysteps):
            ...
            hist_features = color_hist(subimg, nbins=hist_bins) # This is ccreating probelms 
...
features [ 0.3577199   0.36017448  0.36427021 ...,  0.02154187  0.0013946
  0.01342823]
features:  (8460,)
X_scaler:  StandardScaler(copy=True, with_mean=True, with_std=True)
test_features:  (1, 8460)


non-broadcastable output operand with shape (8460,1) doesnt match the broadcast shape (8460,4932)
#,,,

# gets an ValueError: non-broadcastable output operand with shape (8460,1) doesn't match the broadcast shape (8460,4932)

hog_features :  (5292,)
hist_features:  (96,)
spatial_features:  (3072,)
features [[  0.46217257   0.40530097   0.35533038 ...,  11.19010892   0.           0.]]
features:  (1, 8460)
X_scaler:  StandardScaler(copy=True, with_mean=True, with_std=True)


# Output from training Model 
43.7283935546875 Seconds to compute features
Using: YCrCb color space | 5 orientations | 8 pixels per cell and | 2 cells per block | 64 histogram bins and (64, 64) spatial size
Feature vector length: 13460
47.09 Seconds to train SVC...
My SVC predicts:  [ 0.  0.  0.  0.  1.  1.  0.  1.  1.  1.]
For these 10 labels:  [ 0.  0.  0.  0.  1.  1.  0.  1.  1.  1.]
Test Accuracy of SVC =  0.9713 - This is not great, previously was achive 99% 
...
pixel_per_cell = dist_pickle["pixel_per_cell"]
